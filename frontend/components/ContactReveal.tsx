...
export default function HomePage() {
  ...
  return (
    <main className="container mx-auto px-4 py-6">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">The Slice X</h1>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {listings.map((land) => (
            <div key={land.land_id} className="bg-white rounded-xl shadow hover:shadow-lg transition overflow-hidden">
              {/* Image */}
              ...
              <div className="p-4 space-y-2">
                ...
                {/* Contact Reveal */}
                <div className="mt-2">
                  <ContactReveal landId={land.land_id.toString()} />
                </div>
              </div>
            </div>
          ))}
